...
const listMessage = {
  text: tek,
  footer: '📮 *Note:* Jika menemukan bug, error atau kesulitan dalam penggunaan silahkan laporkan/tanyakan kepada Owner Xyna',
            ...
            templateButtons: [
                {
                    urlButton: {
                        ...
                        url: 'https://www.youtube.com/@MaxxyBotz'
                    }
                },
                {
                    urlButton: {
